...
export const InvitationMenu = ({ onPageChange }: InvitationMenuProps) => {
  return (
    <Card
      className="relative w-full max-w-sm mx-auto border-0 shadow-xl overflow-hidden min-h-[650px] flex flex-col bg-contain bg-center bg-no-repeat bg-invitation-light-pink"
